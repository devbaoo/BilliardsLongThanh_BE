...
namespace BilliardsManagerment.Entities;

public partial class BilliardsManagementContext : DbContext
{
    public BilliardsManagementContext()
    {
    }

    public BilliardsManagementContext(DbContextOptions<BilliardsManagementContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=evericks.com;Initial Catalog=BilliardsManagement;Persist Security Info=False;User ID=evericks.billiards;Password=Password123@@;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
